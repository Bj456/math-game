...
function generateEquation() {
    let num2 = Math.floor(Math.random() * 12) + 1; // divisor never 0
    let answerReal = Math.floor(Math.random() * 12);
    let num1 = num2 * answerReal;

    let dummy1 = Math.floor(Math.random() * 12);
    let dummy2 = Math.floor(Math.random() * 12);
